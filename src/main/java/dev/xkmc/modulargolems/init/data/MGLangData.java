...
public enum MGLangData {
	...
	SHIELD_BREAK("tooltip.shield_break", "Shield Breaker", 0, ChatFormatting.GRAY),
	...
	BEACON_BOOTS("tooltip.beacon_boots", "Heal and apply %s, %s to all nearby allies.", 2, ChatFormatting.GRAY),
	...
	APOCALYPTIUM_SWORD("tooltip.revelation.soul_reap", "Deal true damage. Gain soul on dealing damage", 0, ChatFormatting.GRAY),
	APOCALYPTIUM_DASH("tooltip.revelation.dash", "Golem can charge against target to perform dash attack", 0, ChatFormatting.GRAY),
	...
	WAND_RETRIEVE_RIGHT("wand.retrieve_right", "Target a faraway golem to retrieve it.", 0, ChatFormatting.GRAY),
	WAND_RETRIEVE_SHIFT("wand.retrieve_shift", "Retrieve all your surrounding golems.", 0, ChatFormatting.GRAY),
	...
	SLOT_SHOULDER("slot.shoulder", "Shoulder Equipment Slot", 0, ChatFormatting.YELLOW),
	SLOT_MAIN_DESC("slot.main_desc", "Place weapon here. Accepts anything.", 0, ChatFormatting.GRAY),
	SLOT_MAIN_DESC_METAL("slot.main_desc_metal", "Place metal golem weapon here.", 0, ChatFormatting.GRAY),
	...
	UI_PUT_GOLEM("gui.hint.put_golem", "Place golem here", 0, null),
	UI_PUT_TEMPLATE("gui.hint.put_template", "Place golem template here", 0, null),
	UI_PUT_PART("gui.hint.put_part", "Place golem part here", 0, null),
	UI_PUT_PART_MAT("gui.hint.put_part_mat", "Place golem part or material here", 0, null),
	UI_PUT_UPGRADE("gui.hint.put_upgrade", "Place upgrade here", 0, null),
	UI_NO_UPGRADE("gui.no_upgrade", "No upgrades", 0, null),
	UI_SKILL_TITLE("gui.skill_title", "Golem Skills / Upgrades", 0, null),
