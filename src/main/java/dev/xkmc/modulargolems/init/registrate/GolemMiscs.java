...
public class GolemMiscs {
	...
	public static final Val<AbstractShapedRecipe.Serializer<GolemReplaceRecipe>> REPLACE =
			RS.reg("golem_replace_part", () -> new AbstractShapedRecipe.Serializer<>(GolemReplaceRecipe::new));
