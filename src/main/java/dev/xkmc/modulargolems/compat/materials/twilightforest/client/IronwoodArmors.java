...
public class IronwoodArmors {
    ...
    public static final ModelLayerLocation HELMET_LAYER = new ModelLayerLocation(ModularGolems.loc( "ironwood_helmet"), "main");
    public static final ModelLayerLocation CHESTPLATE_LAYER = new ModelLayerLocation(ModularGolems.loc( "ironwood_chestplate"), "main");
    public static final ModelLayerLocation SHINGUARD_LAYER = new ModelLayerLocation(ModularGolems.loc( "ironwood_shinguard"), "main");
    public static final ModelLayerLocation BOOTS_LAYER = new ModelLayerLocation(ModularGolems.loc( "ironwood_boots"), "main");
