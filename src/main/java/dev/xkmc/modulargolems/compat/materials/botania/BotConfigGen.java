...
public class BotConfigGen extends ConfigDataProvider {
	...
	public void add(Collector map) {
		map.add(ModularGolems.MATERIALS, new ResourceLocation(BotDispatch.MODID, "manasteel"), new GolemMaterialConfig()
		...
		map.add(ModularGolems.MATERIALS, new ResourceLocation(BotDispatch.MODID, "terrasteel"), new GolemMaterialConfig()
		...
		map.add(ModularGolems.MATERIALS, new ResourceLocation(BotDispatch.MODID, "elementium"), new GolemMaterialConfig()
