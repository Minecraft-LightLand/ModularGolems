...
public class RVConfigGen extends ConfigDataProvider {
	...
	public RVConfigGen(DataGenerator generator, CompletableFuture<HolderLookup.Provider> pvd) {
		super(generator, pvd, "Golem Config for Royal Variation");
	}

	@Override
	public void add(Collector map) {
		map.add(ModularGolems.MATERIALS, ResourceLocation.fromNamespaceAndPath(RVDispatch.MODID, "royal"), new GolemMaterialConfig()
				.addMaterial(ResourceLocation.fromNamespaceAndPath(RVDispatch.MODID, "royal"),
