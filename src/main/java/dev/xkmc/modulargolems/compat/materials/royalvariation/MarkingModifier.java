...
public class MarkingModifier extends GolemModifier {
	...
	@Override
	public void postHurtTarget(AbstractGolemEntity<?, ?> golem, DamageData.DefenceMax event, int value) {
		event.getTarget().addEffect(new MobEffectInstance(RVEffects.MARKED, 200, value - 1));
	}
