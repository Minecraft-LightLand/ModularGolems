...
public class TFConfigGen extends ConfigDataProvider {
	...
	public void add(Collector map) {
		map.add(ModularGolems.MATERIALS, Identifier.fromNamespaceAndPath(TFDispatch.MODID, TFDispatch.MODID), new GolemMaterialConfig()
				.addMaterial(Identifier.fromNamespaceAndPath(TFDispatch.MODID, "ironwood"), Ingredient.of(ItemTagGenerator.IRONWOOD_INGOTS))
				...
				.addMaterial(Identifier.fromNamespaceAndPath(TFDispatch.MODID, "steeleaf"), Ingredient.of(ItemTagGenerator.STEELEAF_INGOTS))
				...
				.addMaterial(Identifier.fromNamespaceAndPath(TFDispatch.MODID, "knightmetal"), Ingredient.of(ItemTagGenerator.KNIGHTMETAL_INGOTS))
				...
				.addMaterial(Identifier.fromNamespaceAndPath(TFDispatch.MODID, "fiery"), Ingredient.of(ItemTagGenerator.FIERY_INGOTS))
				.addStat(GolemTypes.STAT_HEALTH.get(), 200)
				.addStat(GolemTypes.STAT_ATTACK.get(), 20)
				.addModifier(GolemModifiers.FIRE_IMMUNE.get(), 1)
				.addModifier(GolemModifiers.THORN.get(), 1)
				.addModifier(TFCompatRegistry.FIERY.get(), 2)
				.addModifier(TFCompatRegistry.TF_DAMAGE.get(), 1)
				.addModifier(TFCompatRegistry.TF_HEALING.get(), 1)
				.end()
		);
