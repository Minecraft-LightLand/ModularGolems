...
public class TFConfigGen extends ConfigDataProvider {
	...
	private void addImpl(Map<String, BaseConfig> map) {
		...
		map.put("materials/" + TFDispatch.MODID, new GolemMaterialConfig()
				...
				.addModifier(TFModifiers.TF_DAMAGE.get(), 1)
				.addModifier(TFModifiers.TF_HEALING.get(), 1).end()
				...
				.addModifier(TFModifiers.TF_DAMAGE.get(), 1)
				.addModifier(TFModifiers.TF_HEALING.get(), 1)
				.end()
				...
				.addModifier(TFModifiers.FIERY.get(), 1)
				.addModifier(TFModifiers.TF_DAMAGE.get(), 1)
				.addModifier(TFModifiers.TF_HEALING.get(), 1)
				.end()
		);
