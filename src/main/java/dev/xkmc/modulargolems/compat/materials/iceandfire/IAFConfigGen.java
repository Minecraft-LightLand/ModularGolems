...
public class IAFConfigGen extends ConfigDataProvider {
	...
	public void add(Collector collector) {
		collector.add(ModularGolems.MATERIALS, Identifier.fromNamespaceAndPath(IAFDispatch.MODID, IAFDispatch.MODID), new GolemMaterialConfig()
				.addMaterial(Identifier.fromNamespaceAndPath(IAFDispatch.MODID, "fire_dragonsteel"), Ingredient.of(IAFProxy.get().ingotFireSteel().get()))
				...
				.end()
				.addMaterial(Identifier.fromNamespaceAndPath(IAFDispatch.MODID, "ice_dragonsteel"), Ingredient.of(IAFProxy.get().ingotIceSteel().get()))
				.addStat(GolemTypes.STAT_HEALTH.get(), 400)
				.addStat(GolemTypes.STAT_ATTACK.get(), 40)
				.addModifier(IAFCompatRegistry.ICE_ATK.get(), 1)
				.addModifier(IAFCompatRegistry.ICE_DEF.get(), 1)
				.end()
				.addMaterial(Identifier.fromNamespaceAndPath(IAFDispatch.MODID, "lightning_dragonsteel"), Ingredient.of(IAFProxy.get().ingotLightningSteel().get()))
				.addStat(GolemTypes.STAT_HEALTH.get(), 400)
				.addStat(GolemTypes.STAT_ATTACK.get(), 40)
