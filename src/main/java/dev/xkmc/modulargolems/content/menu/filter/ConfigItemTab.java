...
public class ConfigItemTab extends TabBase<ConfigGroup, ConfigItemTab> {
	...
	public ConfigItemTab(int index, TabToken<ConfigGroup, ConfigItemTab> token, TabManager<ConfigGroup> manager,
	...
	public void onTabClicked() {
		...
		ModularGolems.HANDLER.toServer(new OpenConfigMenuToServer(entry.getID(), entry.getColor(),
				OpenConfigMenuToServer.Type.ITEM));
	}
