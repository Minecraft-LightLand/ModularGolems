...
public class GolemEquipmentModels {
	...
	public static LayerDefinition createHelmetLayer() {
		...
		root.addOrReplaceChild("main_head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -12.1F, -6.5F, 10.0F, 10.0F, 10.0F), PartPose.offset(0.0F, -7.0F, -2.0F));
	...
	public static LayerDefinition createChesplateLayer() {
		...
		root.addOrReplaceChild("main_body", CubeListBuilder.create().texOffs(0, 0).addBox(-9.1F, -2.1F, -6.1F, 18.2F, 12.1F, 11.2F), PartPose.offset(0.0F, -7.0F, 0.0F));
		return LayerDefinition.create(mesh, 64, 64);
	}
