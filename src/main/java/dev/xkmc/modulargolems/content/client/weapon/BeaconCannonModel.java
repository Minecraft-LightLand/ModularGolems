...
public class BeaconCannonModel {
	...
	static {
		RIGHT_START = AnimationDefinition.Builder.withLength(0.25F)
				.addAnimation("flamethrower", new AnimationChannel(AnimationChannel.Targets.ROTATION,
						...
						new Keyframe(0.25F, KeyframeAnimations.degreeVec(99.9904F, -0.0379F, 0.434F), AnimationChannel.Interpolations.LINEAR)
				))
	...
	public static LayerDefinition leftLayer() {
		...
		PartDefinition flamethrower2 = body.addOrReplaceChild("flamethrower2", CubeListBuilder.create().texOffs(0, 15).addBox(-3.0002F, -6.996F, 1.5454F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(20, 15).addBox(-2.0002F, -16.996F, 2.0454F, 2.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(24, 0).addBox(-3.0002F, 0.004F, -0.9546F, 4.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-3.5002F, 0.004F, 1.0454F, 5.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, 5.0F, 4.0F));
	...
	public static LayerDefinition rightLayer() {
		...
		PartDefinition flamethrower = body.addOrReplaceChild("flamethrower", CubeListBuilder.create().texOffs(0, 15).addBox(-9.0F, -7.0F, 1.5F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(20, 15).addBox(-8.0F, -17.0F, 2.0F, 2.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(24, 0).addBox(-9.0F, 0.0F, -1.0F, 4.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-9.5F, 0.0F, 1.0F, 5.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 5.0F, 4.0F));
