	...
	static {
		register(GolemModelPaths.HELMETS,
				new GolemModelPath(GolemEquipmentModels.HELMET_LAYER, List.of(
						...
						List.of("head", "helmet15"),
						List.of("head", "helmet8"),
						List.of("head", "helmet9"),
						List.of("head", "helmet10"),
						List.of("head", "helmet11"),
						List.of("head", "helmet4"),
						List.of("head", "helmet6"),
						List.of("head", "helmet5"),
						List.of("head", "helmet7"),
						List.of("head", "helmet")
				)));
		...
		register(GolemModelPaths.CHESTPLATES,
				new GolemModelPath(GolemEquipmentModels.CHESTPLATE_LAYER, List.of(
						...
						List.of("right_arm", "main_rightarm1"),
						List.of("left_arm", "left_forearm", "main_leftforearm"),
						List.of("left_arm", "main_leftarm1"),
						List.of("left_arm", "main_leftarm2")
				)));
