...
@OnlyIn(Dist.CLIENT)
public class MetalGolemCrackinessLayer extends RenderLayer<MetalGolemEntity, MetalGolemModel<MetalGolemEntity>> {
	...
	public MetalGolemCrackinessLayer(RenderLayerParent<MetalGolemEntity, MetalGolemModel<MetalGolemEntity>> p_117135_) {
		super(p_117135_);
	}
