...
public class MetalGolemRenderer extends MobRenderer<MetalGolemEntity, MetalGolemModel<MetalGolemEntity>> {
	...
	public MetalGolemRenderer(EntityRendererProvider.Context p_174188_) {
		super(p_174188_, new MetalGolemModel<>(p_174188_.bakeLayer(ModelLayers.IRON_GOLEM)), 0.7F);
		this.addLayer(new MetalGolemCrackinessLayer(this));
	}

	public ResourceLocation getTextureLocation(MetalGolemEntity p_115012_) {
		return GOLEM_LOCATION;
	}

	protected void setupRotations(MetalGolemEntity p_115014_, PoseStack p_115015_, float p_115016_, float p_115017_, float p_115018_) {
