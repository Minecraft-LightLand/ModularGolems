...
public class StrayClothingLayer extends RenderLayer<HumanoidGolemEntity, HumanoidGolemModel> implements IMobCloth {
	...
	public void renderHead(PoseStack pose, MultiBufferSource.BufferSource bufferSource, int light, int overlay) {
		...
		model.head.render(pose, bufferSource.getBuffer(RenderType.entityCutoutNoCull(STRAY_CLOTHES_LOCATION)), light, overlay);
	}
	...
	public void render(PoseStack p_117553_, MultiBufferSource p_117554_, int p_117555_, HumanoidGolemEntity p_117556_, float p_117557_, float p_117558_, float p_117559_, float p_117560_, float p_117561_, float p_117562_) {
		coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, STRAY_CLOTHES_LOCATION, p_117553_, p_117554_, p_117555_, p_117556_, p_117557_, p_117558_, p_117560_, p_117561_, p_117562_, p_117559_, 1.0F, 1.0F, 1.0F);
	}
